...
namespace Pulsar.Domain.Atendimentos.Models
{
    public class AtendimentoAuxiliarEnfermagem : AtendimentoComProfissional
    {
        ...
        public AtendimentoAuxiliarEnfermagem(ObjectId usuarioId, ObjectId atendimentoRaizId, ObjectId estabelecimentoId, ObjectId? equipeId, ObjectId pacienteId, Usuario profissional, ObjectId? servicoId, ObjectId? agendamentoId) : base()
        {
